...
print(arreglo2.itemsize)

arreglo3 = arreglo.reshape((3,2))

print(arreglo3)

arreglo = np.append(arreglo,7)
arreglo = np.insert(arreglo,3,100)
print(arreglo)
arreglo = np.delete(arreglo,3)
print(arreglo)

arreglo = np.delete(arreglo,np.where(arreglo == 100))
print(arreglo)

arreglo4 = arreglo*arreglo2*10+1
print(arreglo4)
...
print("El promedio de los imc's es: “,imc.mean())
